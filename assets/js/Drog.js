...
;(function (window, document) {
  if (window.Drog) return console.error('Drog.js has already been defined')
  ...
  function drogMove (e) {
    ...
    if (e.type === touchmove) elmnt = this[father]
    ...
    //elmnt.style.transform = 'translate(32px,0)'
  }
